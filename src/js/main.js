    ...
    <figure>
      <div class="overlay">
        <ul class="level-right">
          <li class="level-item">
            <span class="tag is-success"><i class="entypo-eye"></i>${
              image.views
            }</span>
          </li>
          <li class="level-item">
            <span class="tag is-info"><i class="entypo-thumbs-up"></i>${
              image.likes
            }</span>
          </li>
          <li class="level-item">
            <span class="tag is-danger"><i class="entypo-heart"></i>${
              image.favorites
            }</span>
          </li>
        </ul>
      ...
      <img src=${image.webformatURL} alt=${image.tags} class="fadeIn" >
    </figure>
    `;
